...
def transform_image(img,ang_range,shear_range,trans_range):
 ...
 # Rotation
 ang_range = 128
 ang_rot = (ang_range)-ang_range/ang_range
...
def process(image):
    ...
    image_normal = (image_gray - image_gray.mean())/image_gray.std()
...
with tf.Session() as sess:
    sess.run(tf.global_variables_initializer())
    saver3 = tf.train.import_meta_graph('./Test.meta')
    saver3.restore(sess, "./Test")
